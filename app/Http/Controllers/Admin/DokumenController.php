...
class DokumenController extends Controller
{
    ...
    public function storeadmin(Request $request)
    {
        ...
        return redirect('admin/dokumen')->with(['status' => 'Document Added Successfully', 'status_code' => 'success']);
    }
    ...
    public function editadmin($id)
    {
        ...
        $kategoriList = KategoriDokumen::all();
        return view('admin.dokumen.edit', compact('dokumen','kategoriList'));
    }
    ...
    public function updateadmin(Request $request, $id)
    {
        ...
        return redirect('admin/dokumen')->with(['status' => 'Document updated successfully', 'status_code' => 'success']);
    ...
    public function deleteadmin($id)
    {
        ...
        $dokumen->delete();
        return redirect('admin/dokumen')->with(['status' => 'Document deleted successfully', 'status_code' => 'success']);
    }
