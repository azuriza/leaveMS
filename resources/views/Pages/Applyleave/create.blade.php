        ...
        <div class="col-md-12">
            <div class="card shadow">
                ...
                <div class="card-body">
                    ...
                    @endif
                    <form action="{{url('add/applyleave')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group mb-3" id="handover_container">
                        ...
                        <div class="form-group mb-3" id="handover2_container">
                        ...
                        <div class="form-group mb-3" id="handover3_container">
