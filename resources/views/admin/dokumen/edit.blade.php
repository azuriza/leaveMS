        ...
        <div class="col-lg-12 col-xl-12 col-md-12">
            ...
            <div class="card shadow">
                <div class="card-header">
                    <h4>Edit Documents
                        <a href="{{ url('admin/dokumen') }}" class="btn btn-danger btn-sm float-end rounded-pill">
                            <i class="fa fa-arrow-circle-left" aria-hidden="true"></i> Back
                        </a>
                    </h4>
                </div>
                <div class="card-body">
                    <form action="{{ url('admin/update/dokumen/' . $dokumen->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
