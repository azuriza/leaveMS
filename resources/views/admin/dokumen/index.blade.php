        ...
        <div class="col-lg-12 col-xl-12 col-md-12">
            <div class="card shadow">
                <div class="card-header">
                    <h4>
                        Documents
                        <a href="{{ url('admin/add/dokumen') }}" class="btn btn-primary float-end">
                            ...
                            @foreach($dokumens as $index => $empdata)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ url('admin/edit/dokumen/' . $empdata->id) }}"
                                            class="btn btn-warning btn-sm">
                                            <i class="bi bi-pencil"></i>
                                        </a>
                                        <form action="{{ url('admin/delete/dokumen/' . $empdata->id) }}" method="POST"
