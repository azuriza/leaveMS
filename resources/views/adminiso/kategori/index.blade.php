        ...
        <div class="col-lg-12 col-xl-12 col-md-12">
            <div class="card shadow">
                <div class="card-header">
                    <h4>
                        Category Documents
                        <a href="{{ url('adminiso/add/kategori') }}" class="btn btn-primary float-end">
                        ...
                        <tbody>
                            @foreach($kategori as $index => $empdata)
                                <tr>
                                    ...
                                    <td>{{ $empdata->nama }}</td>
                                    <td>
                                        <a href="{{ url('adminiso/edit/kategori/' . $empdata->id) }}"
                                            class="btn btn-warning btn-sm">
                                            <i class="bi bi-pencil"></i>
                                        </a>
                                        <form action="{{ url('adminiso/delete/kategori/' . $empdata->id) }}" method="POST"
