    ...
    <div class="col-lg-12 col-xl-12 col-md-12">
      ...
      <div class="card shadow">
        <div class="card-header">
          <h4>Applied Leaves
            <a href="{{url('direktur/add/applyleave')}}" class="btn btn-primary btn-sm float-end">Apply Leave</a>
          </h4>
        </div>
        <div class="card-body table-responsive">
          ...
          echo '<svg xmlns="http://www.w3.org/2000/svg" style="display: none;">
                ...
                <td>
                  ...
                  <a href="{{ url('direktur/edit/applyleave/' . $item->id) }}" class="btn btn-warning me-2"
                    title="Update">
                    <i class="bi bi-pencil-fill"></i>
                  </a>
                  <!-- <form action="{{ url('direktur/delete/applyleave/' . $item->id) }}" method="POST"
