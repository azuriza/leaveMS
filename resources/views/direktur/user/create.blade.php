        ...
        <div class="col-lg-12 col-xl-12 col-md-12">
            <div class="card shadow">
                <div class="card-header">
                    <h4>Add User
                        <a href="{{ url('direktur/users') }}" class="btn btn-danger float-end">
                            <i class="fa fa-arrow-circle-left" aria-hidden="true"></i> Back
                        </a>
                    </h4>
                </div>
                <div class="card-body">
                    <form action="{{ url('direktur/add/user') }}" method="POST">
                        @csrf
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <p class="form-control-plaintext">{{ auth()->user()->department->dpname }}</p>
                                @error('department_id')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
