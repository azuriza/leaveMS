        ...
        <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle d-flex align-items-center" id="navbarDropdown" href="#" role="button"
                ...
                <?php if(Auth::user()->profile_picture): ?>
                    <img src="<?php echo e(asset('profile_pictures/' . Auth::user()->profile_picture)); ?>" class="rounded-circle me-2"
                        style="width: 35px; height: 35px; object-fit: cover;" alt="Profile Picture">
                <?php else: ?>
                    <img src="<?php echo e(asset('views/assets/img/avatar.png')); ?>" class="rounded-circle me-2"
...
<?php /**PATH D:\PROJECT\leave-management-system\resources\views/layouts/inc/admin/admin-navbar.blade.php ENDPATH**/ ?>